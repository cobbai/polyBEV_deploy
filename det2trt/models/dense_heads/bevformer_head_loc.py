...
from third_party.bev_mmdet3d.models.builder import build_seg_encoder
...
class BevFeatureSlicer(nn.Module):
    ...
    def __init__(self, map_grid_conf):
        ...
        self.map_grid = torch.stack(torch.meshgrid(
            self.norm_map_x, self.norm_map_y, indexing='ij'), dim=2).permute(1, 0, 2)
...
@HEADS.register_module("BEVFormerHead_loc")
class BEVFormerHead(DETRHead):
    ...
    def __init__(self,
        ...
        self.pc_range = [-20, -35, -5.0, 20, 30, 3.0]
    ...
    def forward_trt(self, mlvl_feats, can_bus, prev_bev, points):
