...
from mmdet.models import DETECTORS
from third_party.bev_mmdet3d.models.detectors.mvx_two_stage import MVXTwoStageDetector
from third_party.bev_mmdet3d.models.utils.grid_mask import GridMask
from third_party.bev_mmdet3d.core.bbox import bbox3d2result
import copy

# @BEVFORMERMODELS.register_module()
@DETECTORS.register_module("BEVFormer_loc")
class BEVFormer(MVXTwoStageDetector):
    ...
    def forward_trt(self, img, can_bus):
        img_feats = self.extract_feat(img=img)
        
        outs = self.pts_bbox_head.forward_trt(img_feats, can_bus=can_bus, prev_bev=None, points=None)
