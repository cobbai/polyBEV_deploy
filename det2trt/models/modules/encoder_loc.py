...
from third_party.bev_mmdet3d.models.modules.custom_base_transformer_layer import MyCustomBaseTransformerLayer
import copy
import warnings
...
@TRANSFORMER_LAYER_SEQUENCE.register_module("BEVFormerEncoder_loc")
class BEVFormerEncoder(TransformerLayerSequence):
    ...
    def forward_trt(
        ...
        *args,
        ...
        # ref_2d = ref_3d[0, 0, :, :2].view(1, -1, 1, 2)
        # ref_3d_65 = ref_2d.clone()

        # 40_65
        ref_3d_65[..., 0:1] = ref_3d_65[..., 0:1] * 4 -2
        ref_3d_65[..., 0] /= 4
        ref_3d_65[..., 1:2] = ref_3d_65[..., 1:2] * 6.5 -3.5
        ref_3d_65[..., 1] /= 6.5
...
@TRANSFORMER_LAYER.register_module("BEVFormerLayer_loc")
